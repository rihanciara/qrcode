                    ...
                    <div class="clearfix">
                        ...
                        <form role="form" action="prescription/addNewPrescription" class="clearfix" method="post" enctype="multipart/form-data">
                            <div class="">
                                ...
                                <div class="form-group col-md-4"><!-- thufail -->
                               <div class="p-3 mb-2 bg-danger text-white"><label for="exampleInputEmail1"> <?php echo lang('patient'); ?> ID: <?php echo $patientid; ?></label> </div>
                                    <select class="form-control m-bot15" id="patientchoose" name="patient" value='' required="">
                                        ...
                                        <?php
                                        if (!empty($setval)) {
                                            $patientdetails = $this->db->get_where('patient', array('<?php echo $patientid; ?>' => set_value('patient')))->row();
                                            ?>
                                ...
                                <div class="form-group col-md-12 panel-body medicine_block">
                                 ...
                                 <div class="form-group col-md-12 panel-body lab_test" style="display: none;">
